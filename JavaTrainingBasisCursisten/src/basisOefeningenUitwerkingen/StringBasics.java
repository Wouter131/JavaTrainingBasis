...
public class StringBasics {
	...
	public static void main(String[] args) {
		...
		System.out.println(a.concat(f).replace("Philips", " is gaaf!").trim());
		System.out.println((a.replace(a.charAt(2), f.charAt(3))).concat(" javacursus"));
		System.out.println(f.concat(e).replace("IBM", " Sport Vereniging"));
		System.out.println(c.replace("Philips", "Hello world en ").concat(a));

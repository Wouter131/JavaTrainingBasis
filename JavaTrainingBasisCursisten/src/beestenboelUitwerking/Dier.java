...
public class Dier {
    ...
    public Dier(String naam, String voedsel) { //constructor
        this();
        this.naam = naam;
    ...
    public String kenmerken() {
    	return getNaam() + " eet: " + getVoedsel() + "\nIk heb geen beschikking over de boolean tam en String soort";
    }

    
/* hieronder staan de getters en setters    
    */
    ...
    public Dier() { //default constructor voeg een constructor toe aan de abstracte class dier (geen vakjes aanvinken)    
      aantal++;    
    }   
